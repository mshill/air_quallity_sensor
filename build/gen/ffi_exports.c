...
void  add_data_value(void *, double);
double  atmospheres_P(double);
double  atmospheres_hg(double);
void  calculate_statistics(void *);
double  ceil(double);
double  celsius(double);
double  compute_altitude(double, double);
double  compute_dewpoint(double, double);
double  cos(double);
char * d_statistics_to_json(void *);
...
double  inches_hg(double);
void * init_d_statistics(int);
double  length_F(double);
double  log(double);
void * malloc(int);
...
const struct mgos_ffi_export ffi_exports[] = {
  ...
  {"atmospheres_P", atmospheres_P},
  {"atmospheres_hg", atmospheres_hg},
  {"calculate_statistics", calculate_statistics},
  {"ceil", ceil},
  {"celsius", celsius},
  {"compute_altitude", compute_altitude},
  {"compute_dewpoint", compute_dewpoint},
  {"cos", cos},
  {"d_statistics_to_json", d_statistics_to_json},
  ...
  {"inches_hg", inches_hg},
  {"init_d_statistics", init_d_statistics},
  {"length_F", length_F},
  {"log", log},
  {"malloc", malloc},
